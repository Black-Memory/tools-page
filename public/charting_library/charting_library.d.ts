 ...
 * 在 `favourites` 组件构造选项中使用的图表类型名称。此类型适用于图表库，如果您正在寻找交易终端类型，请参见 {@link TradingTerminalChartTypeFavorites}。
 *
 ...
 * 请参见 {@link Favorites} 了解可以定义这些收藏夹的组件构造选项，以及 {@link ChartingLibraryWidgetOptions.favorites} 了解组件构造选项。
 */
...
/** This is the list of all featuresets that work on Charting Library 这是适用于图表库的所有功能集列表 */
export type ChartingLibraryFeatureset =
/** Allows storing all properties (including favorites) to the localstorage 允许将所有属性（包括收藏夹）存储到本地存储 @default true */
"use_localstorage_for_settings" |
/** Disabling this feature hides "Favorite this item" icon for Drawings and Intervals 禁用此功能会隐藏绘图和时间间隔的“收藏此项目”图标 @default true */
"items_favoriting" |
/** Can be disabled to forbid storing chart properties to the localstorage while allowing to save other properties. The other properties are favorites in the Charting Library and Watchlist symbols and some panels states in the Trading Terminal 可以禁用以禁止将图表属性存储到本地存储，同时允许保存其他属性。其他属性包括图表库中的收藏夹和监视列表符号以及交易终端中的一些面板状态 @default true @default true */
"save_chart_properties_to_local_storage" |
/** Add the volume indicator upon initialisation of the chart 在图表初始化时添加成交量指标 @default true */
"create_volume_indicator_by_default" |
/** Prevent the volume indicator from being recreated when an instrument or a resolution is switched 防止在切换工具或分辨率时重新创建成交量指标 @default true */
"create_volume_indicator_by_default_once" |
/** Places Volume indicator on the same pane with the main series 将成交量指标放置在与主系列相同的窗格中 @default true */
"volume_force_overlay" |
/** Determines the behavior of Zoom feature: bar under the mouse cursor stays in the same place if this feature is disabled 决定缩放功能的行为：如果禁用此功能，鼠标光标下的K线保持在同一位置 @default true */
"right_bar_stays_on_scroll" |
/** Keeps the dialogs within the chart 将对话框保持在图表内 @default true */
"constraint_dialogs_movement" |
/** Enables logs 启用日志 @default false */
"charting_library_debug_mode" |
/** This enables Drawings Toolbar in the fullscreen mode 在全屏模式中启用绘图工具栏 @default false */
"side_toolbar_in_fullscreen_mode" |
/** Enables header widget DOM element in the fullscreen mode 在全屏模式中启用头部组件DOM元素 @default false */
"header_in_fullscreen_mode" |
/** Shows bar time exactly as provided by the data feed with no adjustments 显示由数据源提供的确切K线时间，不进行任何调整 @default false */
"disable_resolution_rebuild" |
/** Allows chart scrolling 允许图表滚动 @default true */
"chart_scroll" |
/** Allows chart zooming 允许图表缩放 @default true */
"chart_zoom" |
/** If enabled, the chart handles horizontal pointer movements on touch screens. In this case the webpage is not scrolled. If disabled, the webpage is scrolled instead. Keep in mind that if the user starts scrolling the chart vertically or horizontally, scrolling is continued in any direction until the user releases the finger 如果启用，图表将处理触摸屏上的水平指针移动。在这种情况下，网页不会滚动。如果禁用，则网页会滚动。请注意，如果用户开始垂直或水平滚动图表，滚动会在任何方向上继续，直到用户释放手指 @default true */
"horz_touch_drag_scroll" |
/** If enabled, the chart handles vertical pointer movements on touch screens. In this case the webpage is not scrolled. If disabled, the webpage is scrolled instead. Keep in mind that if the user starts scrolling the chart vertically or horizontally, scrolling is continued in any direction until the user releases the finger 如果启用，图表将处理触摸屏上的垂直指针移动。在这种情况下，网页不会滚动。如果禁用，则网页会滚动。请注意，如果用户开始垂直或水平滚动图表，滚动会在任何方向上继续，直到用户释放手指 @default true */
"vert_touch_drag_scroll" |
/** If enabled, chart scrolling with horizontal mouse wheel is enabled 如果启用，则启用使用水平鼠标滚轮进行图表滚动 @default true */
"mouse_wheel_scroll" |
/** If enabled, chart scrolling with left mouse button pressed is allowed 如果启用，允许在按下鼠标左键时滚动图表 @default true */
"pressed_mouse_move_scroll" |
/** If enabled, series scaling with a mouse wheel is enabled 如果启用，则启用使用鼠标滚轮进行系列缩放 @default true */
"mouse_wheel_scale" |
/** If enabled, series scaling with pinch/zoom gestures (this option is supported on touch devices) is enabled 如果启用，则启用使用扏指捐抩/缩放手势进行系列缩放（此选项在触摸设备上受支持） @default true */
"pinch_scale" |
/** If enabled, axis scaling with left mouse button pressed is allowed 如果启用，允许在按下鼠标左键时进行轴缩放 @default true */
"axis_pressed_mouse_move_scale" |
/** Allows zooming in to show up to one bar in the viewport 允许放大以在视窗中显示最多一个K线 @default false */
"low_density_bars" |
/** Disabling this feature allows a user to enter case-sensitive symbols 禁用此功能允许用户输入区分大小写的符号 @default true */
"uppercase_instrument_names" |
/** Disables minimum chart width limitation 禁用最小图表宽度限制 @default false */
"no_min_chart_width" |
/** Prevents scrolling to the left of the first historical bar 防止滚动到第一个历史K线的左侧 @default false */
"fix_left_edge" |
/** Prevents changing visible time area on chart resizing 防止在图表调整大小时改变可见时间区域 @default false */
"lock_visible_time_range_on_resize" |
/** If disabled, adding a new bar zooms out the chart preserving the first visible point. Otherwise the chart is scrolled one point to the left when a new bar comes 如果禁用，添加新K线会缩小图表并保持第一个可见点。否则，当新K线出现时，图表会向左滚动一个点 @default true */
"shift_visible_range_on_new_bar" |
/** If enabled, there is a possibility to add custom resolutions 如果启用，可以添加自定义分辨率 @default false */
"custom_resolutions" |
/** Toggles the timeline marks to display the bar's end time 切换时间线标记以显示K线的结束时间 @default false */
...
/** Removes the header from the chart 从图表中移除头部 @default true */
"header_widget" |
/** Hides the symbol search button from the header 隐藏头部中的符号搜索按钮 @default true */
"header_symbol_search" |
/** Symbol search by pressing any key 通过按任意键进行符号搜索 @default true */
"symbol_search_hot_key" |
/** Hides the resolution button from the header 隐藏头部中的分辨率按钮 @default true */
"header_resolutions" |
/** Displays a `Change interval` dialog to specify another resolution 显示“更改间隔”对话框以指定另一个分辨率 @default true */
"show_interval_dialog_on_key_press" |
/** Hides the chart type button from the header 隐藏头部中的图表类型按钮 @default true */
"header_chart_type" |
/** Relates to Chart Properties button 与图表属性按钮相关 @default true */
"header_settings" |
/** Hides the indicators button from the header 隐藏头部中的指标按钮 @default true */
"header_indicators" |
/** Hides the compare button from the header 隐藏头部中的比较按钮 @default true */
"header_compare" |
/** Hides the undo/redo button from the header 隐藏头部中的撤销/重做按钮 @default true */
"header_undo_redo" |
/** Hides the screenshot button from the header 隐藏头部中的截图按钮 @default true */
"header_screenshot" |
/** Hides the fullscreen button from the header 隐藏头部中的全屏按钮 @default true */
"header_fullscreen_button" |
/** Adds a 2px padding to the chart 为图表添加2像素内边距 @default true */
"border_around_the_chart" |
/** Hides save/load buttons (the feature is not part of `header_widget` featureset) 隐藏保存/加载按钮（此功能不是`header_widget`功能集的一部分） @default true */
"header_saveload" |
/** Hides the left toolbar aka drawings toolbar 隐藏左侧工具栏（即绘图工具栏） @default true */
"left_toolbar" |
/** Relates to the navigation buttons at the bottom of the chart 与图表底部的导航按钮相关 @default true */
"control_bar" |
/** Hide the timeframe toolbar at the bottom of the chart 隐藏图表底部的时间框架工具栏 @default true */
"timeframes_toolbar" |
/** Disabling this feature hides the legend widget 禁用此功能会隐藏图例组件 @default true */
"legend_widget" |
/** Display legend on all diagrams regardless of crosshair synchronization 在所有图表上显示图例，无论十字线同步如何 @default false */
"display_legend_on_all_charts" |
/** Display object tree button in the legend at a small width 在小宽度下在图例中显示对象树按钮 @default true */
"object_tree_legend_mode" |
/** Removes all buttons from the legend except the ellipsis menu 从图例中移除所有按钮，除了省略号菜单 @default true */
